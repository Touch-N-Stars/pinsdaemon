...
class WifiRecoveryCoordinationTests(unittest.TestCase):
    ...
    def test_diagnostics_capture_networkmanager_and_socket_ownership(self):
        ...
        self.assertIn("wifi-regulatory-configuration.txt", source)
        self.assertIn("Configured country:", source)
        self.assertIn("Boot regdom:", source)
        self.assertIn("Runtime country:", source)
        self.assertIn("Consistent:", source)
